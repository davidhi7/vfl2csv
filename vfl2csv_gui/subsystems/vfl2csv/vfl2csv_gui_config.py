...
vfl2csv_gui_config = ConversionGuiConfig(
    text_map=TextMap(
        {
            ...
            "filedialog-input-single-file-filter": f'{setup.config["Input"]["input_format"]}-Dateien (*.{setup.config["Input"]["input_file_extension"]});;'
                                                   f"Alle Dateien (*)",
    ...
    boolean_options=["setting_create_form"],
)
