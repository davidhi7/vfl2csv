...
class TrialSiteConversionTest(unittest.TestCase):
    ...
    def test_filter_columns(self):
        ...
        self.assertEqual(
            filter_df(
                df, [(-1, 'head1'), (-1, 'head2'), (2000, 'measurement'), (2010, 'measurement')], 100
            ).columns.values.tolist(),
            [(-1, 'head1'), (-1, 'head2'), (2000, 'measurement'), (2010, 'measurement')]
        )
